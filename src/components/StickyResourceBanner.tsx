  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ y: -50, opacity: 0 }}
        className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-green-600 to-green-500 text-white py-2.5 px-4 shadow-sm"
      >
        <div className="container mx-auto flex items-center justify-between max-w-7xl">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-0.5 sm:gap-2 min-w-0">
              ...
              <span className="text-xs text-green-100 leading-tight">Speech samples & scripts available</span>
            </div>
          </div>
